        ...
        success: function (data) {
          if(data.question_double == 'error'){
            ...
            $('#main-modal').animate({
              ...
              $("#mssg").html(msg);
              $("#mssg").show();
              setInterval(function(){  $("#mssg").hide(); }, 100000);
          }
          else{
...
function selectPeGroupeSpecialite(){
  if ($('#specialite_groupe').val()){
    $('#type_groupe').removeAttr('disabled');
    selectTypePeGroupe();
  }
  else
    $('#type_groupe').attr('disabled', 'disabled');

}

function selectTypePeGroupe(){
  var specialite = $('#specialite_groupe').val();
  var type_groupe = $('#type_groupe').val();
  getTheContent("pegroupequestions/selectTypePeGroupe/"+specialite+"/"+type_groupe,'#type_groupe_content');
}

...
function get_statistique()
{
    ...
    let loading_content = '<div class="d-flex justify-content-center"><div class="spinner-border" role="status"><span class="sr-only">Chargement en cours...</span></div></div>';
    $("#resutClick_s").html(loading_content).fadeIn('fast');

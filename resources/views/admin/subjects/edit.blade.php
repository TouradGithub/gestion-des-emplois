...
<div class="card">
    <div class="card-header">
        <h4 class="card-title mb-0">
            <i class="fas fa-edit"></i> Modifier la Matière
        </h4>
    </div>
    <div class="card-body">
        <form action="{{ route('web.subjects.update', $subject) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                               value="{{ old('name', $subject->name) }}" required placeholder="Nom de la matière">
                        @error('name')
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="code" class="form-control @error('code') is-invalid @enderror"
                               value="{{ old('code', $subject->code) }}" required placeholder="Code unique">
                        @error('code')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
